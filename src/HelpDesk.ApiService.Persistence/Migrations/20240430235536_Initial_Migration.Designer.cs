...
namespace HelpDesk.ApiService.Persistence.Migrations
{
    ...
    [Migration("20240430235536_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Priority", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Role", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.TicketStatus", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Category", b =>
                {
                    b.HasOne("HelpDesk.ApiService.Domain.Entities.Priority", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.Ticket", b =>
                {
                    b.HasOne("HelpDesk.ApiService.Domain.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("IdCategory")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HelpDesk.ApiService.Domain.Entities.TicketStatus", null)
                        .WithMany()
                        .HasForeignKey("IdStatus")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HelpDesk.ApiService.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HelpDesk.ApiService.Domain.Entities.User", b =>
                {
                    b.HasOne("HelpDesk.ApiService.Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("IdRole")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.OwnsOne("HelpDesk.ApiService.Domain.ValueObjects.Email", "Email", b1 =>
                        {
